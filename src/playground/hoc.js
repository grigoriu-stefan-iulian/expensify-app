    ...
    return (props) => (
        <div>
            {props.isAuthenticated ? (
                <div><p>Wellcome {props.isAuthenticated}</p> <WrappedComponent {...props} /></div>
            ) : (
                    <p>Please Login</p>
                )}
        </div>
...
ReactDOM.render(<AuthInfo isAuthenticated={"false"} info="Info here" />, document.getElementById('app'))